    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='default/no_image.jpg', max_length=255, upload_to=webapp.models.ArticleSeries.image_upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='default/no_image.jpg', max_length=255, upload_to=webapp.models.Article.image_upload_to)),
                ('author', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL)),
                ('series', models.ForeignKey(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='webapp.articleseries', verbose_name='Series')),
            ],
            options={
